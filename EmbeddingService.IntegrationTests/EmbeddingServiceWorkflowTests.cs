...
public class EmbeddingServiceWorkflowTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly HttpClient _client;

    public EmbeddingServiceWorkflowTests(WebApplicationFactory<Program> factory)
    {
