...
public class ElasticsearchService
{
    ...
    public async Task<string> IndexEmbeddingAsync(
    ...
    public async Task<List<SearchResult>> SearchBySimilarityAsync(
    ...
    public async Task<EmbeddingDocument?> GetDocumentAsync(
        string id, 
        CancellationToken cancellationToken = default)
    {
